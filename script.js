...
const moduleCategories = [
    ...
    },
    {
        ...
        options: [
            ...
            { id: 'NC', code: 'NC', label: 'Non-commercial only (NC)', desc: 'Restricts use to non-commercial purposes', isDefault: true },
            { id: 'comm_none', code: '', label: 'Unspecified', desc: 'Assumes default (NC)' }
        ]
    },
    {
        id: 'share',
...
function setupListeners() {
    ...
    if (downloadBtn) {
        downloadBtn.addEventListener('click', () => {
            ...
            licenseText += `https://github.com/arvdevable/ADAB\n`;
            licenseText += `========================================================================\n`;
...
function updateSummary(selectedCodes) {
    ...
    if (selectedCodes.includes('C')) {
        ...
        summaryItems.push('Non-commercial use only (Default NC).');
    }
